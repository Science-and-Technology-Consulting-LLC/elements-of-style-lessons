...
- **In the paired notebook** [`pre-training-creating-kids-first-and-other-accounts.ipynb`](../ipynb/pre-training-creating-kids-first-and-other-accounts.ipynb) — every code cell
